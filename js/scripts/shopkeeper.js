...
var SHK = {
    ...
    options: {
        ...
        counterField: false,
        tocartImage_width: 120,
        tocartImage_height: 120,
    ...
    additOpt: function(elem){
        ...
        if( additPriceSum && !isNaN(additPriceSum) && !SHK.options.changePrice ){
            ...
            var priceTxt = $('.shk-price',parent);
            var curPrice = $(priceTxt).data("price").toString();
            // var curPrice = $(priceTxt).is(".cur-price")
            //     ? $('.cur-price', priceTxt).text()
            //     : $(priceTxt).text();
            ...
            formatPrice = newPrice.split('.');

            // $(priceTxt).empty().append('<span style="display:none;">' + curPrice + '</span>' + newPrice);
            $(priceTxt).empty().append('<span>' + formatPrice[0] + '</span>.' + formatPrice[1] + ' руб.');
